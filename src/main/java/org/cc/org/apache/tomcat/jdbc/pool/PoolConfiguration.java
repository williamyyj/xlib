...
public interface PoolConfiguration {
     ...
     * @see org.cc.org.apache.tomcat.jdbc.pool.interceptor.ResetAbandonedTimer
     */
    ...
    /**
     * A semicolon separated list of classnames extending {@link org.cc.org.apache.tomcat.jdbc.pool.JdbcInterceptor} class.
     * These interceptors will be inserted as an interceptor into the chain of operations on a java.sql.Connection object.
     * Example interceptors are {@link org.cc.org.apache.tomcat.jdbc.pool.interceptor.StatementFinalizer StatementFinalizer} to close all
     * used statements during the session.
     * {@link org.cc.org.apache.tomcat.jdbc.pool.interceptor.ResetAbandonedTimer ResetAbandonedTimer} resets the timer upon every operation
     * on the connection or a statement.
     * {@link org.cc.org.apache.tomcat.jdbc.pool.interceptor.ConnectionState ConnectionState} caches the auto commit, read only and catalog settings to avoid round trips to the DB.
     * The default value is null.
    ...
    /**
     * If set to true, the connection pool creates a {@link org.cc.org.apache.tomcat.jdbc.pool.jmx.ConnectionPoolMBean} object
