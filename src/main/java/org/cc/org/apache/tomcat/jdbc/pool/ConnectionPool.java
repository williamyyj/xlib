...
import org.cc.org.apache.juli.logging.Log;
import org.cc.org.apache.juli.logging.LogFactory;
...
//===============================================================================
        ...
        if (con != null) {
            try {
                ...
                if (con.isSuspect()) {
                    ...
                    if (jmxPool!=null) {
                        jmxPool.notify(org.cc.org.apache.tomcat.jdbc.pool.jmx.ConnectionPool.SUSPECT_RETURNED_NOTIFICATION,
     ...
     * @return the object implementing the {@link org.cc.org.apache.tomcat.jdbc.pool.jmx.ConnectionPoolMBean} interface
     */
